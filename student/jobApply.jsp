...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div class="card card-register mx-auto mt-5">
      <div class="card-header">Apply Job</div>
      <div class="card-body">
        <form method="post" action="InternInfoHandler">
          <div class="form-group">
             <div class="form-label-group">
                 <input type="hidden" name="comname" value="<c:out value="${intern.comname}" />">
                 <input type="hidden" name="comid" value="<c:out value="${intern.comid}" />">
                 <input type="hidden" name="jobid" value="<c:out value="${intern.jobid}" />">
                 <input type="text" name="stdid" value="<%=currentUser.getStdid()%>">
                 Student Name
                 <input type="text" name="stdname" class="form-control" value="<%=currentUser.getStdfname()%>" required="required" autofocus="autofocus">
          ...
          <input type="hidden" name="comemail" value="<c:out value="${intern.comemail}" />">
          
           <c:if test="${intern.jobinterview == 'Available'}">
                         <input type="text" name="interviewstatus" value="Not yet interview">
