    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">View Company Profile</li>
        </ol>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="profile-head">
                                    <h5>
                                        <c:out value="${com.comname}" />
                                    </h5>
                                    <h6>
                                     <i class="fas fa-fw fa-phone-alt"></i>
                                     Phone <c:out value="${com.comphone}" /><br>
                                     <i class="fas fa-fw fa-fax"></i>
                                    Fax <c:out value="${com.comfax}" />
                                    </h6>
                        ...
                        <div class="tab-content profile-tab" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                <p><c:out value="${com.comaddress}" /> </p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-5">
                                                <p><c:out value="${com.comemail}" /></p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">
                                               <a href="/InternSys/CompanyHandler?action=updateCom&id=<c:out value="${com.comid}" />" class="btn btn-primary btn-block"/>Update Info</a>
                                            </div>                                           
                                        </div>
                            </div>
