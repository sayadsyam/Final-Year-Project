      ...
      <div class="card-body">
        <form method="post" action="JobHandler">
          <div class="form-group">
             ...
             Job Position
                 <input type="hidden" name="comid" value="<%=currentUser.getComid()%>">
                 <input type="text" name="stdname" class="form-control" placeholder="Job Position" required="required" autofocus="autofocus">
          ...
          <div class="form-group">
             <div class="form-label-group">
                  Job Status
                  <select class="form-control" name="jobstatus" required="required">
            ...
            <div class="form-label-group">
              Job Allowance
               <select class="form-control" name="joballowance">
                  <option value="#">Choose job allowance</option>
          ...
          <div class="form-group">
            <div class="form-label-group">
            Job Description
              <textarea class="form-control" name="jobdesc" placeholder="Enter job description"></textarea>                    
            </div>
          </div>
